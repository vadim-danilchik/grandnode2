...
using Shipping.Belpost.Configurable.Models;
using Shipping.Belpost.Configurable.Services;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace Shipping.Belpost.Configurable.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    [PermissionAuthorize(PermissionSystemName.ShippingSettings)]
    public class ShippingBelpostController : BaseShippingController
    {
        private readonly IWarehouseService _warehouseService;
        private readonly IShippingMethodService _shippingMethodService;
        private readonly IStoreService _storeService;
        private readonly ICountryService _countryService;
        private readonly IShippingBelpostService _shippingService;
        ...
        public ShippingBelpostController(
            IWarehouseService warehouseService,
            IShippingMethodService shippingMethodService,
            IStoreService storeService,
            ICountryService countryService,
            IShippingBelpostService shippingService,
        ...
        public async Task<IActionResult> RatesByWeightList(DataSourceRequest command)
        {
            ...
            var sbwModel = new List<ShippingBelpostByWeightModel>();

            foreach (var x in records)
            {
                var m = new ShippingBelpostByWeightModel
                {
                    Id = x.Id,
        ...
        {
            var model = new ShippingBelpostByWeightModel();
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> AddByWeightPopup(ShippingBelpostByWeightModel model)
        {
            var sbw = new ShippingBelpostByWeightRecord
            {
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> EditByWeightPopup(ShippingBelpostByWeightModel model)
        {
        ...
        public async Task<IActionResult> RatesByTotalList(DataSourceRequest command)
        {
            ...
            var sbtModel = new List<ShippingBelpostByTotalModel>();

            foreach (var x in records)
            {
                var m = new ShippingBelpostByTotalModel {
                    Id = x.Id,
        ...
        {
            var model = new ShippingBelpostByTotalModel();
            model.PrimaryStoreCurrencyCode = (await _currencyService.GetCurrencyById(_currencySettings.PrimaryStoreCurrencyId)).CurrencyCode;
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> AddByTotalPopup(ShippingBelpostByTotalModel model)
        {
            var sbt = new ShippingBelpostByTotalRecord {
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> EditByTotalPopup(ShippingBelpostByTotalModel model)
        {
